"""Short-term conversation buffer and rolling memory engine with context compaction."""
...
class SessionMemory:
    """Short-term sliding window conversation buffer with token safety and summarization."""
    ...
    def add_message(self, role: str, content: str, metadata: Optional[Dict[str, Any]] = None) -> None:
        """Append a message and perform window compaction if necessary."""
    ...
    def _compact_history(self) -> None:
        """Condense older messages into a rolling semantic summary."""
